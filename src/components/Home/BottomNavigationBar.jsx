...
const BottomNavigationBar = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <TouchableOpacity style={styles.item} onPress={() => navigation.navigate('Request')}>
                <Icon name="bag-outline" size={30} color={iconColor} />
                <Text style={styles.label}>봉투신청</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.item} onPress={() => navigation.navigate('Ranking')}>
                <Icon name="trophy-outline" size={30} color={iconColor}  />
                <Text style={styles.label}>랭킹</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.startButtonContainer} onPress={() => navigation.navigate('Start')}>
